  ...
  return (
    <div className="p-4 animate-in fade-in zoom-in duration-500">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Configuración y cuenta</p>
      </div>

      <div className="clay-card mb-6 overflow-hidden relative">
        <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-r from-warning/30 to-primary/30 opacity-50"></div>
        <div className="p-6 relative z-10 pt-10">
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center gap-2 mt-1 mb-4">
              <span className="px-4 py-1 rounded-full bg-warning/20 text-warning text-xs font-bold uppercase tracking-wider drop-shadow-sm">
                {currentUser.role}
              </span>
          ...
          <div className="space-y-4 mt-6">
            ...
            <div className="clay-input flex items-center justify-between p-4 rounded-2xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-0.5">Ubicación</p>
                  <p className="font-bold text-foreground drop-shadow-sm">Rampa Principal</p>
                </div>
              </div>
            </div>
          </div>
